    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    //Si es empresa
                    if (roles.First() == "Empresa")
                    {
                        int id = this.GetIDByMail(model.Email);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //Asignar el rol "Cliente" al registro un nuevo usuario
                    if (model.Empresa)
                    {
                        await this.UserManager.AddToRoleAsync(user.Id, "Empresa");
        ...
        private int GetIDByMail(string mail)
        {
            //get from DB
